...
const CampaignContent = () => {
    ...
    useEffect(() => {
      ...
      if (loading) {
        return (
          <div className="border-2 border-[#AE94F3] absolute left-1/2 top-1/2 transform -translate-x-1/2 flex items-center gap-3 bg-transparent rounded-lg px-6 py-4">
        ...
        <div className="w-full max-w-full sm:max-w-[95%] mx-auto">
            <div className="rounded-2xl p-2 sm:p-6 mx-2 sm:mx-4 overflow-hidden">
                ...
                >
                    ...
                    style={{backgroundImage: 'linear-gradient(to right, #6A41F5, #AE94F3 29%)'}}>
                        Campaign Details
                    </span>
                    </h1>
                    ...
                    <div className="grid gap-6">
                        {/* Basic Information */}
                        <div className="border-b-2 border-[#9E87E1] pb-6">
                            <h2 className="text-xl sm:text-3xl text-[#AE94F3] font-semibold mb-4 text-700">
                                {campaign.name}
                            </h2>
                        ...
                        {/* Funding Information */}
                        <div className="border-b-2 border-[#9E87E1] pb-6">
                            <h3 className="text-xl sm:text-3xl text-[#AE94F3] font-semibold mb-4 text-700">Funding Status</h3>
                            <div className="grid grid-cols-2 gap-2">
                                <div 
                                    className="border-[3px] border-[#6B42F4] p-4 rounded-xl overflow-hidden w-full" 
                                >
                        ...
                        {/* Deadlines */}
                        <div className="border-b-2 border-[#9E87E1] pb-6">
                            <h3 className="text-xl sm:text-3xl text-[#AE94F3] font-semibold mb-4 text-700">Important Dates</h3>
                            <div className="grid grid-cols-2 gap-2">
                                <div 
                                    className="border-[3px] border-[#6B42F4] p-4 rounded-xl overflow-hidden w-full"
                                >                                    
                        ...
                        {campaign.mint && (
                            <div className="border-b-2 border-[#9E87E1] pb-6">
                                <h3 className="text-xl sm:text-3xl text-[#AE94F3] font-semibold mb-4 text-700">Mint Address</h3>
                        ...
                        {campaign.description && (
                            <div className="border-b-2 border-[#9E87E1] pb-6">
                                <h3 className="text-xl sm:text-3xl text-[#AE94F3] font-semibold mb-4 text-700">Description</h3>
                        ...
                        {campaign.image && (
                            <div className="mt-6">
                                <h3 className="text-xl sm:text-3xl text-[#AE94F3] font-semibold mb-4 text-700">Token Image</h3>
                        ...
                        <div className='relative inline-block group'>
                            {campaign.status === 'COMPLETED' && (
                                <div className="border-b-2 border-[#9E87E1] pb-6">
                                    <h3 className="text-xl sm:text-3xl text-[#AE94F3] font-semibold mb-4 text-700">Market Cap</h3>
                                    <div className='relative'>
                        ...
                        <div className="relative inline-block group">
                            {isCreator && campaign.status === 'COMPLETED' && (
                                <div className="pb-6">
                                    <h3 className="text-xl sm:text-3xl text-[#AE94F3] font-semibold mb-4 text-700">Claimable Token Amount</h3>
                                    <div className='relative'>
                                        <p className="text-white text-800 whitespace-pre-wrap break-all">
