  ...
  return (
    <div className="relative" style={{ left: '0px', top: '0px' }}>
      <div className=" bg-[#070A29]">
        ...
        <img
          loading="lazy"
          src="https://cdn.builder.io/api/v1/image/assets/eab818b3eb2a4948adf5e95f36413932/da5d625a495e761ab294bad5b066a756eb302c363b0de81461b749057f89c8ba?apiKey=eab818b3eb2a4948adf5e95f36413932&"
          alt=""
        ...
        <SocialMedia
          ...
          onClick={() => window.open('https://x.com/FundPlusDotOrg', '_blank')}
        />
