        ...
        <div className={styles.modalOverlay} onClick={onClose}>
            <div className={modalClasses} onClick={(e) => e.stopPropagation()}>
                ...
                <h1 className="text-center text-4xl font-bold mb-6">
                    Pre-Pumpfun: Fundraising and Token Management System
                </h1>
...
3. **Initial Deposit Requirement:** Creators must deposit at least 1 SOL to start the fundraising campaign.  
