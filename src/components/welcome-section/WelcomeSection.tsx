    ...
    >
      <div className=" relative w-[53%] h-full flex flex-col justify-center gap-1 sm:gap-4">
        <h1 className={`text-3xl md:text-8xl text-white ${konkhmer.className} p-1 sm:p-8`}>
          ...
          style={{backgroundImage: 'linear-gradient(to right, #5029D2, #9C8DCE 58%)'}}>
            FundPlus!
          </span>
        </h1>
        <p className={`text-[0.4rem] sm:text-xs text-white p-1 sm:p-8 leading-[2.5] sm:leading-[2.5] ${khmer.className}`}>
          FundPlus is a decentralized crowdfunding platform that allows you to create and fund campaigns with ease.
        </p>
      </div>
      <img
        src="/robot.png"
